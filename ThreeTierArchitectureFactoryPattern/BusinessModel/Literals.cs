...
{ 
    public class Literals
    {
        ...
        public static string SelectOption = "Please Select your Option : ";
        ...
        public static string PasswordRules = "A password should have minimum six characters, at least one letter and one number";
        ...
        public static string ValidInput = "Please provide valid input !!!";
        public static string NonEmptyField = "This field Shouldn't be empty !!!";
